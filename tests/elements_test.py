...
class TestElements:
    class TestTextBox:
        ...
        def test_text_box(self, driver):
            ...
            assert current_address == output_curr_addr, "the current address doesn't match"
            assert permanent_address == output_perm_addr, "the permanent address doesn't match"
